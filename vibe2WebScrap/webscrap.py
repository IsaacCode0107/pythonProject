...
def download_highest_quality_video(link):
    try:
        # 設定下載選項
        #output_directory = "/Users/hank/Library/Mobile Documents/com~apple~CloudDocs/99_roach/60_呈/01_高中/27.丞翊/92.影片"
        #output_directory = "/Users/hank/Library/Mobile Documents/com~apple~CloudDocs/99_roach/60_呈/01_高中/35.紀綱數學/高二（下）數學段考練功坊"
        output_directory = "/Users/hank/Library/Mobile Documents/com~apple~CloudDocs/99_roach/60_呈/01_高中/28.maslu數學/101-108學測"  # 指定下載目錄
        # 確保目錄存在
...
if __name__ == "__main__":
    ...
    download_highest_quality_video(youtube_link)